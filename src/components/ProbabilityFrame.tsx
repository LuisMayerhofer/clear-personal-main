...
const ProbabilityFrame: FC<ProbabilityFrameProps> = ({ profile, chosenScenario }) => {
					...
					<ul className="list-inside list-disc">
						...
						<li>
							{t.rich('probability_bar_info_item_2', {
								// "User" -> User/Red Color
								user: (chunks) => <span style={{ color: GRAPH_COLORS.userProfile }}>{chunks}</span>,
							})}
						</li>
						<li>
	...
	return (
		<section className="relative flex h-full flex-1 flex-col justify-between rounded-2xl bg-white p-[16px] drop-shadow-md">
			...
			>
				<div
					className="relative mx-[16px] h-[43px] w-[90%] rounded-xl"
					style={{
						background: `linear-gradient(to right, ${GRAPH_COLORS.probSliderLeft}, ${GRAPH_COLORS.probSliderRight})`,
					}}
				>
